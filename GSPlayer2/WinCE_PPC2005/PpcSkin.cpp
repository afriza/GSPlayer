	...
	*szBase = NULL;
	...
	{	
		m_himlImageLists[IMAGELIST_NUMBER] = 
			LoadImageList(IML_NUMBER_WIDTH, IML_NUMBER_HEIGHT, szPath, IDB_NUMBER_VGA);
	}
	else
	{
		m_himlImageLists[IMAGELIST_NUMBER] = 
	...
	{	
		m_himlImageLists[IMAGELIST_STATUS] = 
			LoadImageList(IML_STATUS_WIDTH, IML_STATUS_HEIGHT, szPath, IDB_STATUS_VGA);
	}
	else
	{
		m_himlImageLists[IMAGELIST_STATUS] = 
	...
	{	
		m_himlImageLists[IMAGELIST_PLAYOPT] = 
			LoadImageList(IML_PLAYOPT_WIDTH, IML_PLAYOPT_HEIGHT, szPath, IDB_PLAYOPTION_VGA);
	}
	else
	{
		m_himlImageLists[IMAGELIST_PLAYOPT] = 
	...
	if (nVersion < SKIN_CURRENT_VERSION) {
		...
		{	
			m_himlImageLists[IMAGELIST_BUTTON] = 
				LoadImageList(IML_BUTTON_WIDTH, IML_BUTTON_HEIGHT, szPath, IDB_BUTTON_VGA);
		}	
		else
		{
			m_himlImageLists[IMAGELIST_BUTTON] = 
		...
		{	
			m_himlImageLists[IMAGELIST_BUTTON_NORMAL] = 
				LoadImageList(IML_BUTTON2_WIDTH, IML_BUTTON2_HEIGHT, szPath, IDB_BUTTON_NORMAL_VGA);
		...
		{	
			m_himlImageLists[IMAGELIST_BUTTON_PUSH] = 
				LoadImageList(IML_BUTTON2_WIDTH, IML_BUTTON2_HEIGHT, szPath, IDB_BUTTON_PUSH_VGA);
		...
		{	
			m_himlImageLists[IMAGELIST_VOLSLIDER] = 
				LoadImageList(IML_VOLSLIDER_WIDTH, IML_VOLSLIDER_HEIGHT, szPath, IDB_VOLSLIDER_VGA);
		...
		{	
			m_himlImageLists[IMAGELIST_VOLTRACK] = 
				LoadImageList(IML_VOLTRACK_WIDTH, IML_VOLTRACK_HEIGHT, szPath, IDB_VOLTRACK_VGA);
