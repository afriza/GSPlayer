...
#include <aygshell.h>
#ifdef _WIN32_WCE_SP
#define MENU_HEIGHT		(GetSystemMetrics(SM_CXICON) == 32 ? 20 : 26)
#else
...
extern "C"
{
	...
	HWND ShellInitDlgMenu(HWND hwndDlg, UINT uToolBarId = IDR_DIALOG);
	void ShellDestroyDlgMenu(HWND hwndMB);
