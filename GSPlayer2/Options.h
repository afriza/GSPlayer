...
#define KEY_SETTINGS	_T("Software\\GreenSoftware\\GSPlayer\\Settings")
...
#define EXT_LEN		5
	virtual void AssociateFile(LPCTSTR pszExt, LPCTSTR pszKey, LPCTSTR pszName, BOOL fAudioFile = FALSE, UINT uIconID = IDI_FILE);
